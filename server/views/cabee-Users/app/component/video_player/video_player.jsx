...
var VideoPlayer = React.createClass({
    ...
    updateBufferBar: function(buffered){
        ...
        var bufProgress;
        if (this.state.pubInfo[index].buf < 0 ) {
            bufProgress = 0;
        } else {
            bufProgress = Math.abs(Math.floor(this.state.pubInfo[index].buf*10)/10) ;
        };

        // console.log('timebefore :' + timebefore);
        // console.log('buffered: ' + bufProgress+ ' %');
        ...
        client.on('connect', () =>
        {
            ...
            client.emit('progress', this.props.videoName, this.props.urlList[index].text + '.mp4', bufProgress);
        });
    ...
    return (
        <div className="video_player">
            ...
            <div className="video_controls" ref="videoControls">
                <VideoProgressBar 
                        handleProgressClick={this.seekVideo}
                        pubInfo={this.state.pubInfo}
                        totalDuration={this.state.totalDuration}
                ...
                <VideoPlaybackToggleButton 
                        handleTogglePlayback={this.togglePlayback}
                        playing={this.state.playing}/>
                <VideoVolumeButton 
                        muted={this.state.muted} 
